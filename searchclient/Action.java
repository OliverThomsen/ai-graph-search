...
public enum Action
{
    ...
    */
    ...
    PushNE("Push(N,E)", ActionType.Push, -1, 1, 0, 0),
    PushNW("Push(N,W)", ActionType.Push, -1, -1, 0, 0),
    ...
    PullNE("Pull(N,E)", ActionType.Pull, -1, 1, 0, 0),
    PullNW("Pull(N,W)", ActionType.Pull, -1, -1, 0, 0),
